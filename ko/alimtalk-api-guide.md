...
```
* 승인된 템플릿 삭제 시, NHN Cloud 내에서만 삭제됩니다.(3일간 미발송)
* 승인된 템플릿은 카카오 비즈메시지 제약으로 인해, 카카오 내부 데이터는 삭제할 수 없습니다.
* 카카오에 남아있는 템플릿은 미사용 1년 시 휴면 처리, 휴면 1년 후, 삭제 처리 됩니다. (카카오에서 템플릿 휴면/삭제 시, 담당자에게 알림 발송)
